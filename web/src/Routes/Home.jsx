  ...
  return (
    <div className="flex flex-col w-full">
      <div className="flex flex-col lg:flex-row w-full transition-all">
        <div className="border-b border-primary p-8 bg-neutral/50 transition-all lg:w-80">
        ...
        <div className="flex-grow flex flex-row transition-all hover:z-50">
          <Link
            to="/IdeaGen"
            className="border-b-2 p-8 bg-neutral/80 basis-1/3 transition-all hover:bg-black hover:shadow-lg hover:-translate-y-5 hover:z-50"
          >
          ...
          <div className="border-b-2 p-8 bg-neutral/80 basis-1/3 transition-all hover:bg-black hover:shadow-lg hover:-translate-y-5 hover:z-50">
